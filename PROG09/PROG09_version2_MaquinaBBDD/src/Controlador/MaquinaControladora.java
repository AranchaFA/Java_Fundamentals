...
public class MaquinaControladora {
    ...
    public void generarColeccionProductos() {
        ...
        pstmtSQL = this.daoBBDD.obtenerPrepareStatement("11"); // LIBROS
        ...
        pstmtSQL = this.daoBBDD.obtenerPrepareStatement("12"); // CD
        resultSet = daoBBDD.ejecutarPrepareStatementSELECT(pstmtSQL);
        this.productos.putAll(daoVO.coleccionDesdeResultSetCDs(resultSet));

        pstmtSQL = this.daoBBDD.obtenerPrepareStatement("13"); // DVD
        resultSet = daoBBDD.ejecutarPrepareStatementSELECT(pstmtSQL);
        this.productos.putAll(daoVO.coleccionDesdeResultSetDVDs(resultSet));

        pstmtSQL = this.daoBBDD.obtenerPrepareStatement("14"); // PERIODICOS
        resultSet = daoBBDD.ejecutarPrepareStatementSELECT(pstmtSQL);
    ...
    public void cantidadDeCadaTipoDeProducto() {
        ...
        resultSet = this.daoBBDD.ejecutarPrepareStatementSELECT(pstmtSQL);
        ...
        pstmtSQL = this.daoBBDD.obtenerPrepareStatement("23"); // DVD
        resultSet = this.daoBBDD.ejecutarPrepareStatementSELECT(pstmtSQL);
        cantidad = daoVO.extraerValorNumericoConsulta(resultSet);
        System.out.println("Cantidad de DVDs: " + cantidad);

        pstmtSQL = this.daoBBDD.obtenerPrepareStatement("24"); // PERIODICOS
        resultSet = this.daoBBDD.ejecutarPrepareStatementSELECT(pstmtSQL);
        cantidad = daoVO.extraerValorNumericoConsulta(resultSet);
    ...
    public void mostrarTodosLosPeriodicos() {
        ...
        pstmtSQL = this.daoBBDD.obtenerPrepareStatement("14"); // PERIÓDICOS
        resultSet = daoBBDD.ejecutarPrepareStatementSELECT(pstmtSQL);
    ...
    // Buscar un registro en la BBDD (no lo uso)
    public Producto buscarUnRegistro(String codigoProducto, String nombreTabla) {
        ...
        try {
            ...
            if (nombreTabla.equalsIgnoreCase("LIBROS")) {
                ...
                pStmt = daoBBDD.obtenerPrepareStatement("34");
                pStmt.setString(1, codigoProducto);
                resultSet = daoBBDD.ejecutarPrepareStatementSELECT(pStmt);
    ...
    public int borrarUnCDBBDD(String codigo) {
        ...
        try {
            ...
            pstmt = daoBBDD.obtenerPrepareStatement("42");
            // Hay que "cargar" la PStmt con el codigo elegido
            pstmt.setString(1, codigo.toUpperCase());
            // Es una PStmt NO SELECT
            filasEliminadas = daoBBDD.ejecutarPrepareStatementNOSELECT(pstmt);
    ...
    public int borrarUnDVDBBDD(String codigo) {
        ...
        try {
            ...
            pstmt = daoBBDD.obtenerPrepareStatement("43");
            // Hay que "cargar" la PStmt con el codigo elegido
            pstmt.setString(1, codigo.toUpperCase());
            // Es una PStmt NO SELECT
            filasEliminadas = daoBBDD.ejecutarPrepareStatementNOSELECT(pstmt);
    ...
    public int borrarUnPeriodicoBBDD(String codigo) {
        ...
        try {
            ...
            pstmt = daoBBDD.obtenerPrepareStatement("44");
            // Hay que "cargar" la PStmt con el codigo elegido
            pstmt.setString(1, codigo.toUpperCase());
            // Es una PStmt NO SELECT
            filasEliminadas = daoBBDD.ejecutarPrepareStatementNOSELECT(pstmt);
