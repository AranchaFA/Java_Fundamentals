...
public class Controlador_BBDD {
    ...
    public Prestable hacerPrestamo(float codSocio, String codPrestable) {
        Prestable objetoAPrestar = null;
            System.out.println("TODOS LOS OBJETOS A PRESTAR:");
    ...
    public boolean grabarPrestamoEnBBDD(float codSocio, String codPrestable) {
        boolean nuevo;
