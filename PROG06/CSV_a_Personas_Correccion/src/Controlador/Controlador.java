...
public class Controlador {
    ...
    public Object generarUnObjetoPersona() throws IOException {
        ...
        // SE "SALTA" LA EOFEx QUE INCLUIMOS EN ESE MÉTODO  (Creo que no, no salta EOFEx, controlamos con stringLeido!=null)
        String auxString;
    ...
    public void generarFicheroPersonasDesdeCSV() {
        ...
        try {
            daoObjetos.abrirGrabar(); 
            daoCSV.abrirLeer();
        } catch (FileNotFoundException ex) {
            System.out.println("Error al abrir los ficheros. " + ex.getMessage());
            Logger.getLogger(Controlador.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) { 
            System.out.println("Error IO al abrir los ficheros. " + ex.getMessage());
            Logger.getLogger(Controlador.class.getName()).log(Level.SEVERE, null, ex);
        }
