...
// Al incluir souts no es conveniento en la clase, pero bueno....
    ...
    public Jugador generarUnObjeto(String stringDeAtributos) {
        ...
        while (stk.hasMoreTokens()) {
            String numero = stk.nextToken().trim();
            combinacion.add(Integer.valueOf(numero.trim()));
        }
        // Creamos el objeto con los atributos obtenidos
        Jugador objetoGenerado = new Jugador(nombre, apellidos, combinacion);
