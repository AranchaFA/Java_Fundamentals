...
public class Vista {
    ...
    private static void muestraCarta (Carta carta)
    {
        String directorio = "cartas"; //directorio del proyecto donde estan las imagenes
        
        String nomFichero = carta.getFileImagen();
        
         JFrame frame = new JFrame("Carta"); //mensaje que aparecerá en la parte de arriba de la ventana
